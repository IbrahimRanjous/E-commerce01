...
class TGridViewCategories extends StatefulWidget {
  const TGridViewCategories({super.key, required this.categoryFilter});

  final String categoryFilter;

  @override
  State<TGridViewCategories> createState() => _TGridViewCategoriesState();
}

class _TGridViewCategoriesState extends State<TGridViewCategories> {
  @override
